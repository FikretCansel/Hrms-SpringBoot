...
public class AECExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AECDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AECStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AECDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AECDateTimeConverter dateTimeConverter = new AECStandardDateTimeConverter();

    public AECExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AECExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AECMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AECHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AECExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AECHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
