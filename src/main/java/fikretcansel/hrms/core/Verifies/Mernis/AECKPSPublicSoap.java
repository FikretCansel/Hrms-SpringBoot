...
public class AECKPSPublicSoap
{
    ...
    public AECKPSPublicSoap(){}

    public AECKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AECKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AECExtendedSoapSerializationEnvelope envelope= new AECExtendedSoapSerializationEnvelope(AECExtendedSoapSerializationEnvelope.VER11);
